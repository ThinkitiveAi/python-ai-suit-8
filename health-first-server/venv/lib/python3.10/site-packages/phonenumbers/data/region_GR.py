...
PHONE_METADATA_GR = PhoneMetadata(id='GR', country_code=30, international_prefix='00',
    general_desc=PhoneNumberDesc(national_number_pattern='5007005\\d{3}|8\\d{9,11}|(?:[269]\\d|70)\\d{8}', possible_length=(10, 11, 12)),
    ...
    uan=PhoneNumberDesc(national_number_pattern='5007005\\d{3}', example_number='5007005123', possible_length=(10,)),
